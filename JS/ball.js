     /* 2D Breakout game modified from the lesson from MDN Web Docs https://developer.mozilla.org/en-US/docs/Games/Tutorials/2D_Breakout_game_pure_JavaScript
        I don't like how it loads on start and kind of locks the page when it is over. I need to be able to integrate it better into the web browser so that it operates based on the users initialization.
        A random color function was integrated
     */
